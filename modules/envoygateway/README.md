...
A [timoni.sh](http://timoni.sh) module for deploying envoy-gateway to Kubernetes clusters.
...
```shell
timoni -n default apply envoy-gateway oci://<container-registry-url>
```
...
```shell
timoni -n default delete envoy-gateway
```

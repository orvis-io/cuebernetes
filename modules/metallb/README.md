...
A [timoni.sh](http://timoni.sh) module for deploying metallb to Kubernetes clusters.
...
```shell
timoni -n default apply metallb oci://<container-registry-url>
```
...
```shell
timoni -n default delete metallb
```
